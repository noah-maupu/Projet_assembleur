...
while:	
	...
	or $t1, $zero, $t4
	ori $t6, $zero, 0	# nb de calcul bon
	ori $t7, $zero, 0	# nb de calcul
	addi $a2, $zero, 0		
for_Niveau:
...
while_nb_operande: 		#choix d'un nombre aléatoire entre 5 et 10
	#Appel a la fonction random
	ori $a0, $zero, 11	# plafond du random
	jal FctRandom
	lw $fp, 4($sp)		#FIN
